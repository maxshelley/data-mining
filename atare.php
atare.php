...
<style type="text/css">/* CSS style for the Timeline plugin */
...
.href1 .circleLine{
  opacity:1;
      ...
      width: 188.5px;
      height: 188.5px;
      -moz-border-radius: 94.25px;
      -webkit-border-radius: 94.25px;
    ...
    .textincircle1and1 {
      ...
      width: 104.5px;
      height: 104.5px;
      -moz-border-radius: 52.25px;
      -webkit-border-radius: 52.25px;
    ...
    .textincircle3and1 {
      ...
      width: 167.5px;
      height: 167.5px;
      -moz-border-radius: 83.75px;
      -webkit-border-radius: 83.75px;
    ...
    .textincircle4and1 {
      ...
      width: 125.5px;
      height: 125.5px;
      -moz-border-radius: 62.75px;
      -webkit-border-radius: 62.75px;
    ...
    .textincircle6and1 {
      ...
      width: 139.5px;
      height: 139.5px;
      -moz-border-radius: 69.75px;
      -webkit-border-radius: 69.75px;
    ...
    .textincircle1and2 {
      ...
      width: 89.5px;
      height: 89.5px;
      -moz-border-radius: 44.75px;
      -webkit-border-radius: 44.75px;
    ...
    .textincircle3and2 {
      ...
      width: 179.5px;
      height: 179.5px;
      -moz-border-radius: 89.75px;
      -webkit-border-radius: 89.75px;
      border-radius: 89.75px;
      background-color: #f07363;
    }
    .textincircle4and2 {
      height:179.5px;
      width:179.5px;
      ...
      width: 159.5px;
      height: 159.5px;
      -moz-border-radius: 79.75px;
      -webkit-border-radius: 79.75px;
    ...
    .textincircle5and2 {
      ...
      width: 99.5px;
      height: 99.5px;
      -moz-border-radius: 49.75px;
      -webkit-border-radius: 49.75px;
    ...
    .textincircle6and2 {
      ...
      width: 126.5px;
      height: 126.5px;
      -moz-border-radius: 63.25px;
      -webkit-border-radius: 63.25px;
    ...
    .textincircle1and3 {
      ...
      width: 155.5px;
      height: 155.5px;
      -moz-border-radius: 77.75px;
      -webkit-border-radius: 77.75px;
      border-radius: 77.75px;
      background-color: #A744d9;
    }
    .textincircle2and3 {
      height:155.5px;
      width:155.5px;
      ...
      width: 106.5px;
      height: 106.5px;
      -moz-border-radius: 53.25px;
      -webkit-border-radius: 53.25px;
    ...
    .textincircle3and3 {
      ...
      width: 145.5px;
      height: 145.5px;
      -moz-border-radius: 72.75px;
      -webkit-border-radius: 72.75px;
      border-radius: 72.75px;
      background-color: #d53c64;
    }
    .textincircle4and3 {
      height:145.5px;
      width:145.5px;
    ...
    .textincircle6and3 {
      ...
      width: 143.5px;
      height: 143.5px;
      -moz-border-radius: 71.75px;
      -webkit-border-radius: 71.75px;
    ...
    .textincircle1and4 {
      ...
      width: 115.5px;
      height: 115.5px;
      -moz-border-radius: 57.75px;
      -webkit-border-radius: 57.75px;
    ...
    .textincircle2and4 {
      ...
      width: 163.5px;
      height: 163.5px;
      -moz-border-radius: 81.75px;
      -webkit-border-radius: 81.75px;
      border-radius: 81.75px;
      background-color:  #cf0fbf;
    }
    .textincircle3and4 {
      height:163.5px;
      width:163.5px;
      ...
      width: 105.5px;
      height: 105.5px;
      -moz-border-radius: 52.75px;
      -webkit-border-radius: 52.75px;
    ...
    .textincircle5and4 {
      ...
      width: 95.5px;
      height: 95.5px;
      -moz-border-radius: 47.75px;
      -webkit-border-radius: 47.75px;
      border-radius: 47.75px;
      ...
      $('.timeline-circles').bind('click',function(){
        ...
        $('#submit-button').click(function(e){
          ...
          if(errs){
            ...
            var lga=$('#comment_form').find('#lga').val();
            var comment=$('#comment_form').find('#comment_form_area').val();
            var senator=$('#comment_form').find('#senator').val();
            var rep=$('#comment_form').find('#rep').val();
            var minis=$('#comment_form').find('#minis').val();
            var district=senator+','+ rep+','+minis;
            $.get('comment.php?name='+name+'&email='+email+'&lga='+lga+'&comment='+comment+'&district='+district,function(data){
            });   
             
            $('#comment').html('<span id=msg_tnks>Thank you for your feedback. Your petitions will be forwarded to your Representative and Senetorial within 48 hours</span>');
          ...
          <div id="info_comment" class="info-comment" style="display: none">
            ...
            <div id="comment_form" class="comment">
              <div id="comment_form">
                ...
                <form class="form">
                  <bold class="caption">
                    Imagine what oil revenue can do to your community if we have spend it alone on common items
                  </bold>
                  ...
                  <section class="tag-cont">
                    <button name="submit" id="submit-button">submit</button>
                  </section>
                </form>
              </div>
            </div>
